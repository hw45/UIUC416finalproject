(function (topojson,d3) {
  ...
  svg2.append("text")
    ...
    .text("Numbers of countries for each CPIA gender equality rate in 2015");
  ...
  svg3.append("text")
      ...
      .attr('text-anchor', 'middle')
      .style("font-size", "16px") 
      .text("Ratio of each CPIA gender equality rate in 2015");
  ...
  const annotations1 = [{
    note: {
      label: "In 2015, More and more countries supported gender equality, and the gender equality rate temporally increased in developing countries.",
      title: "Summary"
    },
    //can use x, y directly instead of data
    x: 25,
