(function (topojson,d3) {
  ...
  svg2.append("text")
    ...
    .text("Numbers of countries for each CPIA gender equality rate in 2010");
  ...
  svg3.append("text")
      ...
      .attr('text-anchor', 'middle')
      .style("font-size", "16px") 
      .text("Ratio of each CPIA gender equality rate in 2010");
  ...
  const annotations1 = [{
    note: {
      label: "In 2010, most developed countries were unwilling to publish their gender equality rating; More interesting, even the Middle East countries still have over three rates on gender equality rate.",
      title: "Summary"
    },
    //can use x, y directly instead of data
    x: 25,
